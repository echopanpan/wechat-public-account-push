export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "mAoyrdmqASu1MEHe-XKDG-QZ7DLO_TlPYCwXPS-YBJI",
   ...
   *    // 你想对他发送的模板消息的模板ID
   *    useTemplateId: "mAoyrdmqASu1MEHe-XKDG-QZ7DLO_TlPYCwXPS-YBJI",
  ...
  FESTIVALS: [
    ...
    {"type": "节日", "name": "在一起", "year": "2022", "date": "02-22"},
  ],
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
    {"keyword": "encourage_oneself", contents: "久别重逢，佳期如梦，期待我们完整的朝夕♥"},
    // 这样配置的话，就会每次随机选一句话发送
